...
## Frontend
For the user interface, BabelAI uses React, mainly because I'm lazy.  Babel will have desktop deployment using Tauri, with possibility for voice control Client users will interact with the Angular UI or a voice assistant throughout usage.
