...
## Frontend
For the user interface, BabelAI uses Angular, mainly because I haven't really built anything with it yet.  Babel will have desktop deployment using Tauri, with possibility for voice control Client users will interact with the Angular UI or a voice assistant throughout usage.
